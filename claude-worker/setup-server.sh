...
echo "  2. Grant Claude Worker admin access:"
echo "     php artisan claude-worker:admin grant your@email.com"
echo "  3. Navigate to Claude Worker in the nav bar"
echo "  4. Enter your Anthropic API key in the form"
echo "  5. Launch a task!"
echo ""
