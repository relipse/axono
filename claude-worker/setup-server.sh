...
echo "  composer dev"
echo ""
log "Then open: http://your-server:8000/claude-worker/features"
echo ""
log "Make sure to:"
echo "  1. Set an admin password in .env:"
echo "     CLAUDE_WORKER_PASSWORD=your-secret-password"
echo ""
echo "     Or: php artisan claude-worker:password your-secret-password"
echo ""
echo "  2. Login at: http://your-server:8000/claude-worker/login"
